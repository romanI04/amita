...
const buttonVariants = cva(
  'inline-flex items-center justify-center font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background',
  {
    variants: {
      variant: {
        default: 'bg-primary-500 text-white hover:bg-primary-600 shadow-soft hover:shadow-soft-lg focus-visible:ring-primary-500',
        destructive: 'bg-error-600 text-white hover:bg-error-700 shadow-soft hover:shadow-soft-lg focus-visible:ring-error-500',
        outline: 'border border-gray-200 bg-transparent hover:bg-gray-50 text-gray-700 hover:text-gray-900 focus-visible:ring-gray-500',
        secondary: 'bg-white text-gray-900 hover:bg-gray-50 border border-gray-300 shadow-soft hover:shadow-soft-lg focus-visible:ring-gray-500',
        ghost: 'hover:bg-gray-100 text-gray-700 hover:text-gray-900 focus-visible:ring-gray-500',
        link: 'underline-offset-4 hover:underline text-gray-700 hover:text-gray-900',
        ...
        arrow: 'bg-transparent hover:bg-gray-50 text-gray-700 hover:text-gray-900 focus-visible:ring-gray-500 group',
      },
      size: {
